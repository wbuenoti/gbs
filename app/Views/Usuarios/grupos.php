        ...
        <div class="user-block block">
            ...
            <?php if (empty($gruposDisponiveis)) : ?>
                ...
                <?php else : ?>
                    ...
                    <p class="contributions text-white mt-0">Esse usuário faz parte do grupo Administrador. Para associá-lo a
                        outros grupos, primeiro remova-o do grupo de Administrador!</p>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($usuario->grupos as $info) : ?>
                                <tr>
                                    ...
                                    <td><?php echo ellipsize($info->descricao, 40, .5); ?></td>
                                    <td>
                    ...
                    success: function(response) {
                        ...
                        if (!response.erro) {
                            ...
                            window.location.href =
                                "<?php echo site_url("usuarios/grupos/$usuario->id"); ?>";
