...
<head>
  ...
  <title>GBS Serviços | <?php echo $this->renderSection('titulo') ?> </title>
...
<body>
    ...
    <div class="page-content">
      ...
      <section class="no-padding-top no-padding-bottom">
        ...
        <div class="container-fluid">
          ...
          <!-- Espaço reservado para renderizar o conteudo de cada view ue estender esse layout-->
  ...
  <!-- Espaço reservado para renderizar os scripts de cada view ue estender esse layout-->
